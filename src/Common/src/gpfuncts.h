...
extern const wxChar* g_awxpchThirdOctaveBandLabels[];

// Octave band center frequencies array
extern const double  g_adbOctaveBandFcb[];
extern const double  g_adbOneThirdOctaveBandFcb[];

const wxChar* AuroraGetBandLabel(const int nBand, const int type = 1);
